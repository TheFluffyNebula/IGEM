...
class SGEMBestLRNITPlugin(SupervisedPlugin):
    """
    ...
    def __init__(self, patterns_per_exp: int, memory_strength: float, sgd_iterations: int, projection_iteration: int, proj_metric):
        """
    ...
    def solve_dualsgd(self, t, dev, g, I):
        ...
        for _ in range(I):
            ...
            gradF = temp + Gg
            v -= self.lr * gradF
            v = torch.max(v, torch.full_like(v, self.memory_strength))
        return v
